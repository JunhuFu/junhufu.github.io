...
- <strong>J. Fu</strong>, S. Liang, P. Zhou, W. Li, C. Ma, K. Wang, K. Chen, S. Lin, Z. Li, Y. Wang, and Y. Guo, “ColoDiff: Integrating dynamic consistency with content awareness for colonoscopy video generation,” <strong>IEEE Transactions on Medical Imaging</strong>, 2026. (Accepted)[[Paper]](https://ieeexplore.ieee.org/document/11457928)
...
- <span style="color:#666666">L. Liu, P. Huang, B. Guo, S. Liang, <strong>J. Fu</strong>, Z. Zhou, Y. Wang, and Y. Guo, “UniMedDiff: Universal knowledge-enhanced diffusion model for medical image generation from clinical reports,” <strong>npj Digital Medicine</strong>. (Under review)</span>
...
- <span style="color:#666666">K. Wang, <strong>J. Fu</strong>, Y. Zhong, Y. Zhang, L. Ma, J. Hu, M. Cai, W. Qin, X. Ma, P. Zhou, and W. Chen, “Assessment and management of gastrointestinal fistulas following upper gastrointestinal tract tunnel endoscopy,” <strong>Surgical Endoscopy</strong>. (Submitted)</span>
