...
- <span style="color:#666666"><strong>J. Fu</strong>, S. Liang, P. Zhou, W. Li, C. Ma, K. Wang, K. Chen, S. Lin, Z. Li, Y. Wang, and Y. Guo, “ColoDiff: Integrating dynamic consistency with content awareness for colonoscopy video generation,” <strong>IEEE Transactions on Medical Imaging</strong>. (Minor revision)</span>[[Paper]](https://arxiv.org/abs/2602.23203)
...
- <span style="color:#666666">J. Gao, J. Xu, <strong>J. Fu</strong>, Q. Wang, S. Lin, Y. Guo, and Y. Wang, “GPS-SAM: Text-driven grounded polyp segmentation SAM,” <strong>Neurocomputing</strong>. (Major revision)</span>

- <span style="color:#666666">C. Ma, J. Jiao, S. Liang, <strong>J. Fu</strong>, Q. Wang, Z. Li, Y. Wang, and Y. Guo, “TinyUSFM: Towards compact and efficient ultrasound foundation models,” <strong>IEEE Journal of Biomedical and Health Informatics</strong>. (Major revision) [[Paper]](https://arxiv.org/abs/2510.19239)</span>
...
- <span style="color:#666666">L. Liu, P. Huang, B. Guo, S. Liang, <strong>J. Fu</strong>, Z. Zhou, Y. Wang, and Y. Guo, “UniMedDiff: Universal knowledge-enhanced diffusion model for medical image generation from clinical reports,” <strong>Nature Medicine</strong>. (Under review)</span>

- <span style="color:#666666">W. Li, S. Liang, <strong>J. Fu</strong>, S. Zhou, Y. Guo, Q. Tao, and Y. Wang, “SD-CSDT: Single-domain-based content and style disentanglement constrained by mutual information for domain-generalizable medical image segmentation,” <strong>Computerized Medical Imaging and Graphics</strong>. (Under review)</span>

- K. Wang, <strong>J. Fu</strong>, Y. Zhong, Y. Zhang, L. Ma, J. Hu, M. Cai, W. Qin, X. Ma, P. Zhou, and W. Chen, “Assessment and management of gastrointestinal fistulas following upper gastrointestinal tract tunnel endoscopy,” <strong>Surgical Endoscopy</strong>. (Submitted)
